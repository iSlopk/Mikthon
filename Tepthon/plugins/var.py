...
BaqirVP_cmd = (
    "𓆩 [ 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - أوامر الفـارات](t.me/slopk) 𓆪\n\n"
    ...
    "⪼ قنـاة كلايـش الفحـص @slopkklaesh\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد على الكليشـه مـن القنـاة @slopkklaesh\n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @slopkklaesh\n\n"
    ...
    "\n𓆩 [𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/slopke1) 𓆪"
)


BaqirTZ_cmd = (
    "𓆩 [𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 - أوامر الوقت](t.me/slopk) 𓆪\n\n"
...
async def custom_rep(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @slopk**".format(input_str, variable))
        ...
        if variable is None:
            await zed.edit("**⎉╎فـار ايموجي/رمز الايدي غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد على الكليشـة من هنا ( @slopkklaesh ) استخـدم الأمـر : ↶**\n `.اضف كليشة الايدي` \n\n**⎉╎قنـاة السـورس : @slopk**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @slopk**".format(input_str, variable))
