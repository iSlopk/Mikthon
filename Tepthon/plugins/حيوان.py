...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 𓆪 </b> - @slopk "
...
async def who(event):
    ...
    if replied_user.id in zel_dev:
       return await edit_or_reply(zed, "**- دي . . إنـهُ احـد المطـورين . . انتـه الحيـوان ولك**")
    if replied_user.id == 1332671807 or replied_user.id == 189519306 or replied_user.id == 209557462:
       return await edit_or_reply(zed, "**- دي . . إنـهُ المطـور . . انتـه الحيـوان ولك**")
