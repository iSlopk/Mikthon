...
zed_dev = (658351825, 589554306, 9848752505, 528089206, 54281890871)
zel_dev = (6583951825, 5451890871, 9373975462)
zelzal = (1332671807, 1895219306, 5280339206)
...
################# Dev ZilZal #################
    ZThon = f'<a href="T.me/slopk">ᯓ 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗗𝗮𝘁𝗮 📟</a>'
    ZThon += f"\n<b>⋆─┄─┄─┄─┄─┄─┄─⋆</b>\n\n"
...
################# Dev ZilZal #################
    if user_id in zelzal: 
        ...
        rotbat = "العضـو 𓅫"
################# Dev ZilZal #################
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت ميكثـون"  
    ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ " 
    ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝑴𝑰𝑲𝑻𝑯𝑶𝑵 ─┄─┄─┄─⋆" 
