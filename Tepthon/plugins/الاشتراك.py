...
async def supc(event):  # Zed-Thon - ZelZal
    ...
    zed_dev = (1332671807, 925972505, 5176749470, 5280339206)
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            if "error_code" in reqt:
                await zedub.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ غير معروف قم باعادة توجيه الرسالة ل@ASX16 لحل المشكلة\n{reqt}**")
