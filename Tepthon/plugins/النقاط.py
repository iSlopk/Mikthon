...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 - أوامـر تجميـع النقـاط](t.me/slopk) 𓆪\n\n"
    "**⎉╎قـائمـة أوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس ميكثـون🦾 :** \n\n"
    "`.المليار`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- ملاحظـة :**\n"
    "**⪼ سيتم إضـافـة المزيـد من البوتـات بالتحديثـات القادمـة .. إذا تريـد إضـافة بـوت محـدد راسـل مطـور السـورس @ASX16**"
)
