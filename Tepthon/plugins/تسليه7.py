...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1332671807 or idd == 189519306 or idd == 580339206 or idd == 134642270:
            ...
            animation_chars = [
                "**⌔: جاري الاتصال بخوادم ميكثون المتخصصه بالـتهكير**",
                ...
                f"**⌔︙تـم اختـراق حسـاب الضـحية. ** \n\n**⪼ قـم بالـدفع الـى** {DEFAULTUSER} **لعـدم نشـر معلـوماتك وصـورك ||اسمع يواد، وربي امزح يهو لا تزعل 👀||**",
            ]
