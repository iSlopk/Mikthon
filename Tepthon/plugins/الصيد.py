...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 - أوامـر الصيد والتشيكـر](t.me/slopk) 𓆪\n\n"
    ...
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن ميـكثون**\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 - أنـواع اليـوزرات](t.me/slopk) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد ميـكثون 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 ⎉",

                    about="This channel to hunt username by - @slopk ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت ميـكثون 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس ميـكثون - @slopk ",
